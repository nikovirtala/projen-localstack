...
| <code><a href="#@nikovirtala/projen-localstack.LocalStack.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@nikovirtala/projen-localstack.LocalStack.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@nikovirtala/projen-localstack.LocalStack.with.parameter.mixins"></a>
